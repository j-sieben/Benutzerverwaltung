...
begin
   ...
   */
  :new.ben_id := nvl(:new.ben_id, bv_benutzer_seq.nextval);
  :new.ben_aktiv_von := nvl(:new.ben_aktiv_von, trunc(sysdate));
  :new.ben_aktiv_bis := nvl(:new.ben_aktiv_bis, date '2030-12-31');
end;
/
